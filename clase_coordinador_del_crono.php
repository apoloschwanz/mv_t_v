...
class Coordinador_del_crono extends relacionj {
		...
		{	
			...
			$this->obj_lado_muchos = new Coordinador_para_asignar() ;
			//
			// Prefijo campo
			$this->prefijo_campo = 'm_cordos_del_crono_' ;
			//
			// Lista de Campos
			//
			...
			$this->lista_campos_lista[]=array( 'nombre'=>'Coordinador_Id' 			, 'tipo'=>'pk' 		, 'descripcion'=>'#' , 'clase'=>NULL ) ;
			...
			$this->lista_campos_lectura[]=array( 'nombre'=>'descrip' 	, 'tipo'=>'text' 	, 'descripcion'=>'Coordinador' , 'clase'=>NULL ) ;
			...
			$this->lista_campos_nombre[]='Coordinador_Id' ;
		...
		{
		$this->strsql = "SELECT coordinadores_de_la_capacitacion.Coordinador_Id ,
														personas.`Apellido y Nombre` as Nombre 
											...
											WHERE coordinadores_de_la_capacitacion.Coordinador_Id = '".$this->id."' and Crono_Id = '".$this->id_lado_uno."' " ;
		}
		protected function Carga_Sql_Lista()
		{
		$this->strsql = "SELECT coordinadores_de_la_capacitacion.Coordinador_Id , 
														personas.`Apellido y Nombre` as Nombre , 
														'C' as Estado_Asignacion , 
														coordinadores_de_la_capacitacion.Control_Coordinador
					...
					if (  isset($_REQUEST [$nom_check] ) )
						{ 
							...
							$strsql = "INSERT INTO ".$this->nombre_fisico_tabla." 
																 (".$this->nombre_id_lado_uno.", ".$this->lista_campos_nombre[0]." , Control_Coordinador  ) 
