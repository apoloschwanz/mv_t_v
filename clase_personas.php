...
class persona extends entidadj {
	 ...
	 * */
		...
		{	
			...
			$this->lista_campos_lectura[]=new campo_entidad( 'Persona_Id' 			, 'pk' 		, '#'  ) ;
			$this->lista_campos_lectura[]=new campo_entidad( '`Apellido y Nombre`' 	, 'text' 	, 'Nombre'  ) ;
			$this->lista_campos_lectura[]=new campo_entidad( 'Cuit_Prefijo' 	, 'number' 	, 'Prefijo CUIT'  ) ;
			$this->lista_campos_lectura[]=new campo_entidad( 'DNI' 	, 'number' 	, 'DNI'  ) ;
			$this->lista_campos_lectura[]=new campo_entidad( 'Cuit_Sufijo' 	, 'number' 	, 'Sufijo CUIT'  ) ;
			$this->lista_campos_lectura[]=new campo_entidad( 'Cargo_Id' 	, 'fk' 	, 'Cargo' , new cargo() ) ;
			$this->lista_campos_lectura[]=new campo_entidad( 'Organismo_Id' 	, 'fk' 	, 'Organismo' , new organismo()   ) ;
			$this->lista_campos_lectura[]=new campo_entidad( 'Sector' 	, 'text' 	, 'Sector'  ) ;
			$this->lista_campos_lectura[]=new campo_entidad( 'Oficina' 	, 'textarea' 	, 'Oficina'  ) ;
			$this->lista_campos_lectura[]=new campo_entidad( 'Fecha_de_Nacimiento' 	, 'date' 	, 'F. de Nac.'  ) ;
